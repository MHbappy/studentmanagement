...
public class AssignmentRepositoryTest {
    ...
    void test_findAllByIsActive(){
        ...
        student.setId(1l);
        Assignment assignment1 = new Assignment(1l, "assignment1", new byte[2], "pdf", true, student);
        Assignment assignment2 = new Assignment(1l, "assignment2", new byte[2], "pdf", true, student);
